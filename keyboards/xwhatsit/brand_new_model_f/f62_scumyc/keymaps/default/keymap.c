...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO, KC_RSFT,
        KC_CAPS, KC_LGUI, MO(_FN), KC_LALT,                KC_SPC,              KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT_all(
        ...
        _______, _______, _______, _______,                  MO(_FN2),                  _______, _______, _______, _______
    ),
    [_FN2] = LAYOUT_all(
