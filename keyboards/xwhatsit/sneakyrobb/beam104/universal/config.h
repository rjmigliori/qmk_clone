...
#define MANUFACTURER Tom Wong-Cornall/Purdea Andrei/kmnov2017/listofoptions/SneakyRobb
#define PRODUCT SneakyRobb 104-key beamspring
#define DESCRIPTION QMK firmware for SneakyRobb 104-key beamspring keyboard using a 'universal' xwhatsit controller PCB
