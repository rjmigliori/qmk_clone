...
#define PRODUCT IBM 4704 F62
#define DESCRIPTION QMK firmware for the IBM 4704 F62 keyboard using the original Xwhatsit model F controller PCB
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) ((col)+2)
