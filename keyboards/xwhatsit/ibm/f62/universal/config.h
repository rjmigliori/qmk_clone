...
#define DESCRIPTION QMK firmware for the IBM 4704 F62 keyboard using a 'universal' xwhatsit controller PCB
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) (15-((col)+2))
