...
#define PRODUCT IBM Typewriter 65/85/95
#define DESCRIPTION QMK firmware for the IBM Typewriter 65/85/95 keyboard using a 'universal' xwhatsit controller PCB
