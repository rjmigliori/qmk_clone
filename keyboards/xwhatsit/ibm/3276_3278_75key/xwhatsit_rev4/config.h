...
#define PRODUCT IBM 3276 or 3278
#define DESCRIPTION QMK firmware for the IBM 3276 or 3278 keyboard using the original Xwhatsit beamspring rev. 4 controller PCB
