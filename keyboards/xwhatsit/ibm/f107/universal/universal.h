...
// There is one next to the left shift, on row 6. (columns in probably 3)
// There is one to the left of the backspace key, on row 2 (column is probably 10 (or 11? but less likely))
// There is one to the left of the enter key, on row 4 (column is probably 9)
// There is one to the left of right-shift key, row 6 (column is probably 10)
// There is one under the + key, on row 5 (column is probably 15)
// There is one under the kp enter key, on row 8 (column is probably 15)
// There is one to the right of the kp 0 key, on row 8 (column is probably 14)
