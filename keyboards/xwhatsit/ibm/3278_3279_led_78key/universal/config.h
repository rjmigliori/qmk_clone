...
#define PRODUCT IBM 3278 or 3279 with top module
#define DESCRIPTION QMK firmware for the IBM 3278 or 3279 keyboards that also have a top led and button module, using a 'universal' xwhatsit controller PCB
