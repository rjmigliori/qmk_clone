...
#define DESCRIPTION QMK firmware for the IBM 3277 66-key keyboards using emdude sense PCB, and a 'universal' xwhatsit controller PCB
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) (((col) <= 7) ? ((col) + 5) : ((col) + 6))
