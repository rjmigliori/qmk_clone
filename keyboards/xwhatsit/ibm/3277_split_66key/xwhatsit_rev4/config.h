...
#define DESCRIPTION QMK firmware for the IBM 3277 split 66-key keyboards using emdude sense PCB, and the original Xwhatsit beamspring rev. 4 controller PCB
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) (((col) <= 8) ? ((col) + 4) : ((col) + 5))
